...
import ro.ulbsibiu.ccsd.laboratory.robert.encryption.huffman.SymbolCounter;
...
public class SymbolCounterTest {
    ...
    void mergeSymbolCounters() {
        ...
        SymbolCounter symbolCounter5 = symbolCounter1.mergeWith(symbolCounter2);
        ...
        SymbolCounter symbolCounter6 = symbolCounter3.mergeWith(symbolCounter4);
        ...
        SymbolCounter symbolCounter7 = symbolCounter5.mergeWith(symbolCounter6);
